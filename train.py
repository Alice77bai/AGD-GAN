...
parser.add_argument('--name', type=str,default='zong',help='name of this experiment')
...
###loading data
parser.add_argument('--dataroot', type=str, default='examples/train/photos/', help='photograph directory root directory')
parser.add_argument('--root2', type=str, default='examples/train/drawings/', help='line drawings dataset root directory')
parser.add_argument('--depthroot', type=str, default='examples/train/depthmaps/', help='dataset of corresponding ground truth depth maps')
...
### save options
parser.add_argument('--save_epoch_freq', type=int, default=2, help='how often to save the latest model in steps')
...
netG_A = 0
netG_A = Generator(opt.input_nc, opt.output_nc, opt.n_blocks)  #(3,1)
netG_B = Generator(opt.output_nc, opt.input_nc, opt.n_blocks)  #(1,3)
