...
parser.add_argument('--name', required=True, type=str,help='clean-tidugai')
...
parser.add_argument('--geom_name', type=str, default='grad', help='name of the geometry cpredictor')
parser.add_argument('--batchSize', type=int, default=1, help='size of the batches')
parser.add_argument('--dataroot', type=str, default='examples/test', help='root directory of the dataset')
parser.add_argument('--depthroot', type=str, default='examples/depth', help='dataset of corresponding ground truth depth maps')
...
parser.add_argument('--which_epoch', type=str, default='139', help='which epoch to load from')
# parser.add_argument('--aspect_ratio', type=float, default=2156, help='The ratio width/height. The final height of the load image will be crop_size/aspect_ratio')
...
parser.add_argument('--predict_depth', type=int, default=False, help='run geometry prediction on the generated images')
...
parser.add_argument('--how_many', type=int, default=2000, help='number of images to test')
